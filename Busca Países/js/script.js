...
async function fetchCountries() {
  ...
  allCountries = json.map((country) => {
    const { name, population, flag, capital, numericCode } = country;
...
function addToFavorites(id) {
  const countryToAdd = allCountries.find((button) => button.id === id);favoriteCountries = [...favoriteCountries, countryToAdd];
